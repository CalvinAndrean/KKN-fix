    ...
    <VerticalTimeline>
        ...
        <Link href="../perjalanan-kkn/day-1">
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle text-black">
              📌Kampus 3, Universitas Atma Jaya Yogyakarta
            </h4>
      ...
      <div className="mb-[32px]">
        <Link href="../perjalanan-kkn/day-4">
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle text-black">
              📌GOR Kalurahan Guwosari
            </h4>
            <p className="text-black">
              Mengikuti acara pertemuan karang taruna (SARAKATA) se-Kabupaten
              Bantul
            </p>
          </VerticalTimelineElement>
        </Link>
      ...
      <div className="mb-[32px]">
        <Link href="../perjalanan-kkn/day-5">
          ...
          >
            <h3 className="vertical-timeline-element-title text-black">
              Program kerja Kesehatan dan Pengolahan Sampah
            </h3>
            <h4 className="vertical-timeline-element-subtitle text-black">
              📌SPS Dahlia 1 dan 📌RT.03
            </h4>
            <p className="text-black">
              Berpartisipasi dalam kegiatan Posyandu Balita serta pelaksanaan
      ...
      <div className="mb-[32px]">
        <Link href="../perjalanan-kkn/day-9">
          ...
          >
            ...
            <p className="text-black">
              Hari kosong dimana diisi dengan olahraga tenis meja dan menonton
              film bersama
            </p>
          </VerticalTimelineElement>
        </Link>
      ...
      <div className="mb-[32px]">
        <Link href="../perjalanan-kkn/day-10">
          ...
          >
            ...
            <p className="text-black">
              Membersihkan serta menghias PAUD Dahlia 1 dengan kertas origami
              dan lampion
            </p>
          </VerticalTimelineElement>
        </Link>
      ...
      <div className="mb-[32px]">
        <Link href="../perjalanan-kkn/day-11">
          ...
          >
            <h3 className="vertical-timeline-element-title text-black">
              Program kerja sosialisasi UMKM Aldyo, Feli, Yolen
            </h3>
            <h4 className="vertical-timeline-element-subtitle text-black">
              📌Rumah Wakil Bupati Bantul
            </h4>
            <p className="text-black">
              Melaksanakan Program Kerja Sosialisasi UMKM bersama para ibu-ibu
      ...
      <div className="mb-[32px]">
        <Link href="../perjalanan-kkn/day-12">
          ...
          >
            <h3 className="vertical-timeline-element-title text-black">
              Program kerja Hukum dan Sipil
            </h3>
            <h4 className="vertical-timeline-element-subtitle text-black">
              📌RT.06 &📌RT.03
            </h4>
            <p className="text-black">
              Melaksanakan Sosialisasi Bantuan Hukum dan Struktur Atap Baja
              Ringan
            </p>
          </VerticalTimelineElement>
        </Link>
      ...
      <div className="mb-[32px]">
        <Link href="../perjalanan-kkn/day-13">
          ...
          >
            <h3 className="vertical-timeline-element-title text-black">
              EVALUASI TENGAH BULAN
            </h3>
            <h4 className="vertical-timeline-element-subtitle text-black">
              📌Posko KKN 83 UAJY Pringgading
            </h4>
            <p className="text-black">
              Melaksanakan Evaluasi tiap-tiap program kerja yang telah
              terlaksana
            </p>
          </VerticalTimelineElement>
        </Link>
      ...
      <div className="mb-[32px]">
        <Link href="../perjalanan-kkn/day-15">
          ...
          >
            ...
            <p className="text-black">
              Melaksanakan Program Kerja Pendidikan: Perkenalan dan Lomba
              Mewarnai
            </p>
          </VerticalTimelineElement>
        </Link>
      ...
      <div className="mb-[32px]">
        <Link href="../perjalanan-kkn/day-16">
          ...
          >
            <h3 className="vertical-timeline-element-title text-black">
              Program kerja Teknologi Tepat Guna
            </h3>
            <h4 className="vertical-timeline-element-subtitle text-black">
              📌RT.03 &📌RT.05
            </h4>
            <p className="text-black">
              Mengumpulkan data untuk keperluan Program Kerja Teknologi Tepat
              Guna
            </p>
          </VerticalTimelineElement>
        </Link>
      ...
      <div className="mb-[32px]">
        <Link href="../perjalanan-kkn/day-20">
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle text-black">
              📌Lapangan Badminton RT.04 Blok VI
            </h4>
            <p className="text-black">
