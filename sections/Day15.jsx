  ...
  return (
    <div>
        ...
        >
          ...
          <div class="flex flex-col justify-between p-4 leading-normal">
            ...
            <p class="mb-3 font-normal text-gray-400">
              Hari ini kami mengadakan Program Kerja Pendidikan: Perkenalan dan
              Lomba Mewarnai untuk PAUD Dahlia 1.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-center mt-[64px] mb-[64px]">
        ...
        >
          <img
            class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-72 md:rounded-none md:rounded-l-lg mr-[30px]"
            src="/day15/1.jpg"
            alt=""
          />
          <img
      ...
      <div className="flex justify-center mt-[64px] mb-[64px]">
        ...
        >
          <img
            class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-80 md:rounded-none md:rounded-l-lg mr-[30px]"
            src="/day15/3.jpg"
            alt=""
          />
          <img
            class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-80 md:rounded-none md:rounded-r-lg"
            src="/day15/4.jpg"
            alt=""
          />
          {/* <div class="flex flex-col justify-between p-4 leading-normal">
