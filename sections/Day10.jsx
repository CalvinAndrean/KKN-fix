        ...
        >
          ...
          <div class="flex flex-col justify-between p-4 leading-normal">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-white">
              Menghias PAUD Dahlia 1
            </h5>
            <p class="mb-3 font-normal text-gray-400">
              Menghias PAUD masuk kedalam salah satu program kerja kami aspek
              Inovasi Dusun. Kami merasa bahwa PAUD harus memiliki lingkungan
              yang menarik dan cukup nyaman untuk bermain agar anak anak tidak
              merasa tertekan dan dapat bermain sekaligus belajar dengan lancar.
            </p>
          </div>
        </div>
      </div>
