  ...
  return (
    <div>
        ...
        >
          ...
          <div class="flex flex-col justify-between p-4 leading-normal">
            ...
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
              Kelompok kami mengadakan Evaluasi Tengah Bulan untuk membahas
              mengenai evaluasi seluruh program kerja yang telah terlaksana
              serta rencana pelaksanaan program kerja selanjutnya. Selain itu,
              kami juga membahas mengenai beberapa masalah yang kami hadapi baik
              dengan masyarakat sekitar maupun internal kelompok.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-center mt-[64px] mb-[64px]">
        ...
        >
          <img
            class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-56 md:rounded-none md:rounded-l-lg mr-[30px]"
            src="/day13/1.jpeg"
            alt=""
          />
          <img
            class="object-cover w-full h-96 md:h-auto md:w-72 mr-[30px]"
            src="/day13/2.jpg"
            alt=""
          />
          <img
          ...
          />
          <img
            class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-72 md:rounded-none md:rounded-r-lg"
            src="/day13/4.jpg"
            alt=""
          />
          {/* <div class="flex flex-col justify-between p-4 leading-normal">
